    ...
    <React.Fragment>
      ...
      <section className='overflow-hidden'>
        <div>
            ...
            <div className='flex items-center justify-between -m-2'>
              <div className='flex flex-wrap items-center w-auto p-2'>
                <a className='block max-w-max xl:mr-14' href='#'>
                  <img
                    src='../assets/images/logo.svg' sizes='40px'
                    alt=''
                  />
                </a>
                <ul className='hidden xl:flex flex-wrap'>
                  <li className='mr-8'>
                    <Link to="/"  className='flex flex-wrap items-center py-8 text-base font-medium text-coolGray-500 hover:text-green-500 border-b-2 border-transparent hover:border-green-500'
                      >
                    <svg
                        className='mr-2'
                        width={24}
                      ...
                      <p className='text-coolGray-800'>Home</p>
                    </Link>
                  </li>
                  <li className='mr-8'>
                    <Link  className='flex flex-wrap items-center py-8 text-base font-medium text-coolGray-500 hover:text-green-500 border-b-2 border-transparent hover:border-green-500'
                      to="/About">
                         <svg
                        className='mr-2'
                        width={24}
                  ...
                  <li className='mr-8'>
                    <a
                      className='flex flex-wrap items-center py-8 text-base font-medium text-coolGray-500 hover:text-green-500 border-b-2 border-transparent hover:border-green-500'
                      href='#'
                    >
                      <svg
                        className='mr-2'
          ...
          <div className='navbar-menu z-50 fixed top-0 hidden flex xl:hidden flex-col justify-between bg-white border-r border-coolGray-100 max-w-xs w-9/12 h-full overflow-y-auto'>
